...
8. Ejecuta el comando `Revo64`. Si tienes una salida que no parezca error, la VM está lista.
...
16. Ir a [](https://portal.azure.com)
17. Ir a "Resources"
...
Esto te permitirá acceder al RStudio Server con la siguiente URL: [](https://rstudioserver.southcentralus.cloudapp.azure.com:8787)
